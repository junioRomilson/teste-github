...
@logout
@fluxo_incluir_alocacao_terceirizado_nominal
...
@Fluxo_Sistema_Completo
  Cenario: Solicitação de Alocação Nominal Mobilização - Terceirizado.
    ...
    # Aba - Definir Contingênte (Por Cargo):
        ...
        E Realizo as definições seguintes: Tipo de Contingente 'Nominal', e informo os integrantes da alocacao
        E Autoridade 'RODRIGO DE CAMPOS COSTA', Informações 'Informações - Automação',
